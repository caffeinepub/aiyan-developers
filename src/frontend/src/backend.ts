...
export class Backend implements backendInterface {
    ...
    async addProject(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string): Promise<void> {
    ...
    async getAllServices(): Promise<Array<[string, string]>> {
        if (this.processError) {
            try {
    ...
    async updateProject(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string): Promise<void> {
        if (this.processError) {
            try {
